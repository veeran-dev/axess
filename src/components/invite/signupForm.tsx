            ...
            <div className="mx-auto w-full max-w-sm lg:w-96">
              <div>
                <Image
                    ...
                    width={120}
                />
                <h2 className="mt-8 text-2xl/9 font-bold tracking-tight text-gray-900">Create your account as Organizer</h2>
              </div>
...
export default withPublicLayout(OrganizerSignUp)